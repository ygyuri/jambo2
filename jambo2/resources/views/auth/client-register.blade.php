...
<body class="bg-gradient-primary">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="mb-4 text-gray-900 h4">Create a Client Account!</h1>
              </div>
              <form action="{{ route('client.register.save') }}" method="POST" class="user">
                @csrf
  ...
  <script src="{{ asset('admin_assets/vendor/jquery-easing
